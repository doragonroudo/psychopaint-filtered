...
import { TouchableWithoutFeedback, KeyboardAvoidingView, View, Text, TextInput , Image, TouchableOpacity, ScrollView, SafeAreaView, Keyboard } from 'react-native';
...
class HTPInfoScreen extends Component {
      ...
      <View style={styles.infoContainer}>  
        ...
        <View style={styles.rowInfoContainer}>
          ...
          <CheckBox
            ...
            status='primary'
            >
              <Text style={styles.fontHeader}>ข้าพเจ้ายินยอมในการทำแบบทดสอบ</Text>
          </CheckBox>
          </View>
        </View>
      ...
      <View style={styles.rowMainContainer}>
            <View style={{width: screenWidth/2,alignItems:'flex-start'}}>
              <Button 
                ...
                appearance='outline' 
                status='primary'
                onPress={ () => this.navigateToBack('HTPMode') }
              >
